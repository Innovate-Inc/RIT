...
define([
  ...
  function (
    ...
    LoadingShelter, ioquery, SpatialReference, registry, WidgetManager, PanelManager
    ) { /*jshint unused: false*/
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      search: function (geometry, layerIndex, /* optional */expressIndex, theValue, spatialRelationship, closeOnComplete) {
        ...
        var featureLayer = new FeatureLayer(layerConfig.url, {mode: FeatureLayer.MODE_SNAPSHOT, outFields: fields});
        ...
        on(featureLayer, 'load', lang.hitch(this, function(){
          featureLayer.queryFeatures(query, lang.hitch(this, this._onSearchFinish, layerIndex, featureLayer, closeOnComplete), lang.hitch(this, this._onSearchError));
        }));
      },
...
//todo consider adding back the required flag
      ...
      _onSearchFinish: function (layerIndex, featureLayer, closeOnComplete, results) {
        var layerConfig = this.config.layers[layerIndex];
        var currentLayer;
        var showAttachments = false;
        if('showattachments' in layerConfig && layerConfig.showattachments){
